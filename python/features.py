...
class Features:
    ...
    def fill_row_features(self, board, pla, opp, boards, moves, move_idx, rules, bin_input_data, global_input_data,
                          idx):
        ...
        if rules["scoringRule"] == "SCORING_AREA" and rules["taxRule"] == "TAX_NONE":
            ...
            board.calculateArea(area, nonPassAliveStones, safeBigTerritories, unsafeBigTerritories,
